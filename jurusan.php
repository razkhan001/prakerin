        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="template.php?modul=jurusan&act=tambah" class="btn 
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <th><center>Singkatan Nama jurusan</th>
                      <th width=10%>Aksi</th>
                  </tr>
                  </thead>
                  <tbody>
                ...
                <tr>
                      ...
                      <td><?php echo $valuej["nama_jurusan"]; ?></td>
                      <td><?php echo $valuej["skt_jurusan"]; ?></td>
                      <td>
                        <a href="template.php?modul=jurusan&act=edit&id=<?=$valuej['idj']?>" class="btn 
                        btn-warning"><i class="fas fa-pen"></i></a>
                        <a href="pjurusan.php?proses=hapus&id=<?=$valuej['idj']?>" 
            ...
            <form action='pjurusan.php?proses=simpan' method='POST'>
            ini halaman tambah
            <table>
            <tr>
            ...
            <tr>
              <td><b>Singkatan jurusan</b></td>
              <td><input type='text' name='skt'></td>
            </tr>
            </table>
            <br><button class='btn btn-primary'>simpan</button>
            <a href='template.php?modul=jurusan'><span class='btn btn-danger'>kembali</span></a>  
            </form>
            ...
            case"edit";
            $s = $smk->prepare("select *from jurusan where idj = '$_GET[id]'");
            $s->execute();
            $ds = $s->fetch();

            echo"<div class='card'>
            <div class='card-body'>
           <form action='pjurusan.php?proses=edit' method=POST>
            ini halaman edit
            ...
            <tr>
              <td><b>Nama Jurusan</b></td>
              <td><input type='text' name='nama' value='$ds[nama_jurusan]'></td>
            </tr>
            <tr>
              <td><b>Singkatan Jurusan</b></td>
              <td><input type='text' name='skt' value='$ds[skt_jurusan]'></td>
            </tr>
            </table>
            <br><button class='btn btn-primary'>simpan</button>
            <a href='template.php?modul=jurusan'><span class='btn btn-danger'>kembali</span></a>
